...
4. `bindings/libchatllm.h` - API declarations
5. `bindings/chatllm.py` - Python bindings
6. `scripts/binding.py` - Path resolution fix
...
1. **Memory leak in chatllm_destroy** - Needs proper GGML resource cleanup
...
- Memory profiling (leak identified, documented separately)
